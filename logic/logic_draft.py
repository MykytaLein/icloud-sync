...
def load_photos(appleId: str, pwd: str, 
    ...
    #     exitloopcondition = ((not hasattr(dlphoto,'added_date')) 
    #                             or (dlphoto.added_date <= fromDate) 
    #                             or (dlphoto.added_date > toDate))
...
# fromDate = tz.localize(fromDate, is_dst=None).astimezone(pytz.utc)
# print(fromDate)
